							...
							switch (number)
							{
								...
								case "# ":
									...
									else
									{
										...
										{
											File.WriteAllText(@"B:\Tortoise911\Tortoise911\DEBUGCONF\Headder.txt", line);
										}
									};
									break;
								...
								case "GE":
#if DEBUG
									File.WriteAllText(@"B:\Tortoise911\Tortoise911\DEBUGCONF\GET.txt", line);
#endif
									try
									{
...
#if DEBUG
										File.WriteAllText(@"B:\Tortoise911\Tortoise911\DEBUGCONF\" + number + ".txt", number);
#endif
									}
									break;
										...
										if (Application.UserAppDataRegistry.GetValue("PROV_GRP") != null)
										{
											if (Application.UserAppDataRegistry.GetValue("PROV_GRP").ToString() != "False")
											{
												...
												if (line.Contains($"IF $GROUP SEQ " + Application.UserAppDataRegistry.GetValue("PROV_GRP").ToString()))
												{
													...
													searchmode = true;
#if DEBUG
													File.WriteAllText(@"B:\Tortoise911\Tortoise911\DEBUGCONF\IF.txt", line + $"||||" + searchHeadder);
#endif
												}
											}
										}
